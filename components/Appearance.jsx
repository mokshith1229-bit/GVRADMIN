    ...
    return (
        <div className="flex flex-col h-full -m-6 md:-m-8">
            ...
            <div className="flex flex-1 overflow-hidden">
                {/* Navigation Sidebar */}
                <aside className="w-64 border-r bg-gray-50/50 p-6 hidden lg:block overflow-y-auto">
                ...
                <main className="flex-1 overflow-y-auto p-4 md:p-8 bg-white">
                    ...
                    <div className="lg:hidden flex items-center gap-2 overflow-x-auto scrollbar-hide pb-6 mb-2">
                        {sections.map(section => (
                            <button
                                key={section.id}
                                onClick={() => setActiveSection(section.id)}
                                className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold whitespace-nowrap transition-all border ${activeSection === section.id
